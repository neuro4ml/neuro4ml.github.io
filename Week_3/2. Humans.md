...
2. If we manipulate specific parts of the brain, we see specific differences in behavior. So while we do these manipulations in animal models, in humans these manipulations usually result from accidents, disease processes or surgical interventions.
    ...
    For example, in the [same paper](https://doi.org/10.1093/brain/123.2.291), the authors also studied two patients who had damaged part of their corpus callosum. These patients lost relatively specific function and in this study, they were unabe to read words aloud that were presented in the left visual field.
