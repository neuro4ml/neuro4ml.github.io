...
[Downlod the slides here](W6-V1-analysing.pptx)
...
In the last section we learnt about how we can acquire neural data. Now we're going to think about how we can interpret or analyse that data.
...
In [this paper](https://www.nature.com/articles/nature05601) the authors let a rat freely move around a square area while recording the activity of neurons in part of the brain known as the hippocampus.
...
Neurons with responses like these are known as **place cells**, they were first discovered in [1971](https://pubmed.ncbi.nlm.nih.gov/5124915/), but are still an active area of research.
...
In the next video, we’ll cover how to manipulate neural activity.
