...
```{figure} src\3\Slide4.png
:label: integrateandfire
:alt: Integrate and Fire Model
:align: center

Graphs Detailling Behavior of Integrate and Fire Model
```
